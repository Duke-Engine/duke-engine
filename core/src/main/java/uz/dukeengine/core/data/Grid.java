 ...
 * cell — {@code Cells = ["#####", "#000#", …]}.
 *
 * <p>The engine reads it as the rows it is -- see {@code uz.dukeengine.core.map.MapTerrain}, which lays a grid from
 * them -- and so does an editor, which draws the rows as the map they are, and every other component of the record that holds a cell — a record with an
