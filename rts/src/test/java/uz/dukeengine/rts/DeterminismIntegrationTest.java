...
class DeterminismIntegrationTest {
    ...
    static final class BattleLogic extends RtsSimulation {
        ...
        private void forEach(List<uz.dukeengine.core.thing.ObjectId> ids, java.util.function.Consumer<GameObject> action) {
            for (var id : ids) {
    ...
    void scenarioActuallyProgresses() {
        ...
        var defender = logic.findObject(new uz.dukeengine.core.thing.ObjectId(2));
