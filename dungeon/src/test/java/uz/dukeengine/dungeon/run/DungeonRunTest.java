...
class DungeonRunTest {
    ...
    void aNewHeroStartsWithNothing() {
        var settings = uz.dukeengine.dungeon.content.DungeonSettings.load();
    ...
    private static void kill(uz.dukeengine.game.DukeGame game, Dungeon.Session session) {
        var hero = uz.dukeengine.dungeon.skill.Skills.heroOf(game.getLogic(),
        ...
        game.runHeadless(uz.dukeengine.core.GameConstants.LOGICFRAMES_PER_SECOND * 12);
    }
}
