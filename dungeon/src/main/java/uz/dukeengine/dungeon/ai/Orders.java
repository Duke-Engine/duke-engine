...
public final class Orders {
    ...
    private final java.util.Map<Integer, uz.dukeengine.core.thing.ObjectId> watching =
            new java.util.HashMap<>();

    /** Say which creature a player has picked out, or {@code null} for none. */
    public void watch(int playerIndex, uz.dukeengine.core.thing.ObjectId unit) {
        if (unit == null) {
    ...
    public uz.dukeengine.core.thing.ObjectId watchedBy(int playerIndex) {
     ...
     */
    private final java.util.Map<Integer, uz.dukeengine.core.math.Coord3D> marching =
            new java.util.HashMap<>();

    /** Send that player's creatures fighting their way to a spot, or call it off. */
    public void attackMove(int playerIndex, uz.dukeengine.core.math.Coord3D spot) {
        if (spot == null) {
    ...
    public uz.dukeengine.core.math.Coord3D attackMovingTo(int playerIndex) {
