 ...
 *       which hands the choice to {@link uz.dukeengine.dungeon.ai.HeroBrain}. The
...
public final class EyesOnly extends Module implements WeaponHold {
     ...
     */
    private final uz.dukeengine.dungeon.content.DungeonSettings settings;

    public EyesOnly(GameObject owner, uz.dukeengine.dungeon.content.DungeonSettings settings) {
        super(owner);
